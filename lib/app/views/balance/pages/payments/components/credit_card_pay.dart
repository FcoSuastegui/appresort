...
import 'package:appresort/app/views/balance/pages/payments/bloc/credit_card_bloc.dart';
...
class CreditCardPayment extends StatelessWidget {
  final double total;
  const CreditCardPayment({Key key, this.total})
      : assert(total != null),
        super(key: key);
