import 'package:appresort/app/views/listar-cargos/components/listar_cargos_body.dart';
...
class ListarCargosView extends GetView<ListarCargosController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
        () => controller.loading ? Center(child: CircularProgressIndicator()) : ListarCargosBody(),
      ),
    );
  }
}
