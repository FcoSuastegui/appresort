...
class Network {
  ...
  // Servicios
  Future<Response> postFormData({String route, Map<String, dynamic> data}) async =>
      await _dio.post("/$route", data: FormData.fromMap(data));
  Future<Response> post({@required String route, Map<String, dynamic> data}) async =>
      await _dio.post("/$route", data: data);
